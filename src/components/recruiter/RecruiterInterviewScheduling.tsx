...
const RecruiterInterviewScheduling: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600">
        Manage and schedule interviews for candidates. This is a recruiter-specific tool for detailed interview coordination.
      </p>
...
export default RecruiterInterviewScheduling;
